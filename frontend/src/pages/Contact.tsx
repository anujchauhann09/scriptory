        ...
        <Container className="max-w-2xl">
          ...
          >
            <div className="mb-12 text-center">
              <span className="text-xs font-bold uppercase tracking-widest text-brand">Say hello</span>
              <h1 className="mb-4 mt-3 font-display text-4xl font-extrabold tracking-tight sm:text-5xl">
            ...
            <form onSubmit={handleSubmit} className="glass space-y-6 rounded-3xl p-6 shadow-lg shadow-black/5 sm:p-8">
              <div className="space-y-2">
                ...
                <Input id="name" name="name" placeholder="Your Name" required className="focus-visible:ring-brand/50" />
              </div>
              <div className="space-y-2">
                <label htmlFor="email" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  Email
                </label>
                <Input id="email" name="email" type="email" placeholder="your.email@example.com" required className="focus-visible:ring-brand/50" />
              </div>
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  name="message"
                  rows={5}
                  className="flex w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/50 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
